...
public class NPCMovement : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        occupiedSeats = NPCSpawner.instance.occupiedSeats;
        SetPosition();
    ...
    public void Leave(float timer)
    {
        StartCoroutine(CustomerLeave(timer));

        
    }

    public IEnumerator CustomerLeave(float timer)
    {
    ...
    IEnumerator Order()
    {
        ...
        OrderManager.instance.platePositionList.Add(platePos.gameObject);
